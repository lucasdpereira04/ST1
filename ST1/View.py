...
from Controller import BoatController  # Import statement added
...
def create_gui(controller):
    ...
    feature_selection_btn = tk.Button(root, text="Feature Selection", command=feature_selection_callback, **button_style)
    ...
    train_test_split_btn = tk.Button(root, text="Train/Test Split and Model Evaluation", command=train_test_split_callback, **button_style)
